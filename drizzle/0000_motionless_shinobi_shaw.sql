...
CREATE INDEX "idx_challenge_user" ON "challenge_participations" USING btree ("user_id","challenge_id");--> statement-breakpoint
CREATE INDEX "idx_comm_member" ON "community_members" USING btree ("user_id","community_id");--> statement-breakpoint
CREATE INDEX "idx_health_user_type" ON "health_logs" USING btree ("user_id","type","logged_at");--> statement-breakpoint
CREATE INDEX "idx_assignment_user" ON "mediator_assignments" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "idx_visit_mediator" ON "mediator_visits" USING btree ("mediator_id","visit_date");--> statement-breakpoint
CREATE INDEX "idx_notif_user" ON "notifications" USING btree ("user_id","is_read");--> statement-breakpoint
CREATE INDEX "idx_progress_user" ON "progress" USING btree ("user_id","pillar_id");--> statement-breakpoint
CREATE INDEX "idx_rating_provider" ON "provider_ratings" USING btree ("provider_id");--> statement-breakpoint
CREATE INDEX "idx_provider_region" ON "providers" USING btree ("region","type");--> statement-breakpoint
