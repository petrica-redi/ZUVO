      ...
      <main id="main-content" className="flex-1">
        <section className="relative overflow-hidden bg-white px-5 pb-5 pt-6">
          ...
          <div className="mb-3 inline-flex items-center gap-1.5 rounded-full border border-red-100 bg-red-50 px-3 py-1 animate-fade-in-up">
            ...
            <span className="text-[11px] font-bold text-[#C0392B]">{tHome("aiBadge")}</span>
          </div>
          ...
          <h1 className="mb-2 text-[28px] font-black leading-[1.08] tracking-tight animate-fade-in-up delay-100" style={{ letterSpacing: "-0.03em" }}>
            ...
            <br />
            <span className="text-gray-900">{tHome("headline2")}</span>
          </h1>

          <p className="mb-5 text-[14px] leading-relaxed text-gray-500 animate-fade-in-up delay-200 whitespace-pre-line">
            {tHome("tagline")}
          </p>
          ...
          <div className="flex gap-3 animate-fade-in-up delay-300">
            ...
            >
              <MessageCircle className="h-5 w-5" /> {tHome("ctaAsk")}
            </Link>
            <Link
              href="/consult"
            ...
            >
              <Stethoscope className="h-5 w-5 text-emerald-500" /> {tHome("ctaConsult")}
            </Link>
          </div>
        </section>
          ...
          <div className="grid grid-cols-3 divide-x divide-gray-100 rounded-2xl bg-white shadow-sm" style={{ border: "1px solid rgba(0,0,0,0.04)" }}>
            {[
              ...
              <div key={stat.labelKey} className="flex flex-col items-center py-3.5">
                ...
                <span className="text-[10px] font-semibold text-gray-400">{tHome(stat.labelKey)}</span>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="px-4 pt-4 pb-2">
          <h2 className="mb-3 text-[16px] font-black text-gray-900">{tHome("quickSection")}</h2>
        ...
        <section className="px-4 pt-6 pb-2">
          <h2 className="mb-3 text-[16px] font-black text-gray-900">{tHome("learnTitle")}</h2>
