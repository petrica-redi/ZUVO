...
const STATIC_KEYS = [
  ...
  "qualityScan",
  "qualityResolve",
  "qualitySeverity_info",
  "qualitySeverity_warning",
  "qualitySeverity_critical",
  "qualityStatus_open",
  "qualityStatus_acknowledged",
  "qualityStatus_resolved",
  "qualityStatus_dismissed",
  "qualityFlag_missing_outcome",
  "qualityFlag_stale_case",
  "qualityFlag_missing_consent",
  "qualityFlag_duplicate_entry",
  "qualityFlag_incomplete_barriers",
  "qualityFlag_overdue_followup",
  "qualityFlag_no_recent_contact",
] as const;
