...
export const REGIONS: RegionData[] = [
  ...
  },
  {
    ...
    ambulanceNumber: "118",
    healthChallenges: [
      "Large Romanian diaspora (~1M) including informal settlements",
      "STP/ENI codes unknown to most undocumented and non-registered EU citizens",
      "Barriers to tessera sanitaria for mobile EU citizens",
      "Housing insecurity limiting continuity of care",
      "Language barriers in ASL and hospital settings",
    ],
    organizations: [
      {
        name: "UNAR — Ufficio Nazionale Antidiscriminazioni Razziali",
        type: "government",
        focus: "National Roma, Sinti and Caminanti strategy",
        website: "https://www.unar.it",
      },
      {
        name: "Associazione 21 Luglio",
        type: "ngo",
        focus: "Roma rights and health access in Italy",
        website: "https://www.21luglio.org",
      },
      {
        name: "Médecins du Monde Italia",
        type: "international",
        focus: "STP/ENI registration and essential care for excluded persons",
        website: "https://www.medicideldmondo.it",
      },
    ],
    keyFact: "Italy grants free essential care via STP and ENI codes — but fewer than 1 in 10 eligible people know how to obtain them.",
    healthIndex: 3,
  },
  {
    id: "bulgaria",
